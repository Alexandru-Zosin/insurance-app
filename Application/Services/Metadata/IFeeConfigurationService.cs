...
public interface IFeeConfigurationService
{
    ...
    Task<Result<ListFeeConfigurationsResponse>> ListFeeConfigsAsync(CancellationToken ct = default);
    Task<Result<SetFeeConfigStatusResponse>> SetFeeConfigStatusAsync(Guid feeConfigId, bool request, CancellationToken ct = default);
